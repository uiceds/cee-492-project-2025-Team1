...
The correlation heatmap in Figure 3 shows that compressive strength is most positively associated with cement content and testing age, and negatively associated with water content. This finding is consistent with the classical water-to-binder effect, where excess water weakens the concrete matrix. Superplasticizers show a slight positive correlation with compressive strength, as they reduce water demand and lower the water-to-binder ratio, thereby improving strength. The aggregate contents show weak correlations with compressive strength, while fine and coarse aggregates are negatively correlated with each other due to volumetric trade-off. Fly ash and slag are negatively correlated with cement content, reflecting their role as partial cement replacements.
